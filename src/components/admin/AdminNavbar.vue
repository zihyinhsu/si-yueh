<template>
    <div class="sidebar d-flex flex-column justify-content-between w-25 bg-primaryDark vh-100 p-12">
        ...
        <div>
            ...
            class="btn  btn-light d-flex justify-content-center align-items-center text-primaryDark" to="/">
